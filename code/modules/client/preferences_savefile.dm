...
//		clane = new newtype()
	...
	Charisma				= sanitize_integer(Charisma, 1, 10, initial(Charisma))
	Manipulation				= sanitize_integer(Manipulation, 1, 10, initial(Manipulation))
	Appearance				= sanitize_integer(Appearance, 1, 10, initial(Appearance))
	Perception				= sanitize_integer(Perception, 1, 10, initial(Perception))
	Intelligence				= sanitize_integer(Intelligence, 1, 10, initial(Intelligence))
	Wits				= sanitize_integer(Wits, 1, 10, initial(Wits))
